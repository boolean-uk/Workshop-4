...
const myRecipes = new RecipeBook("Kye's Recipe Book");

myRecipes.addRecipe(
  "Butter on toast",
  [{ name: "Slice of bread", quantity: 1 }],
  "Put the slice of bread in the toaster until cooked and spread butter."
);

console.log(
  myRecipes.addRecipe("Recipe", [{ name: "Slice of bread", quantity: 1 }], "")
);
